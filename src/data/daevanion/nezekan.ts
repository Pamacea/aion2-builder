...
// Les nodes Rare et Legend n'ont plus de stats génériques
// Elles utilisent maintenant passiveId ou abilityId pour augmenter un sort/passif spécifique
...
nezekanRunes.push(createRune(0, 4, "rare", {}, 2)); // (0,4) - Rare - Passive ID 2
nezekanRunes.push(createRune(0, 5, "common", {criticalHitResist: commonStats.criticalHitResist })); // (0,5) - Common
nezekanRunes.push(createRune(0, 6, "legend", 10)); // (0,6) - Legend - Ability ID 10
nezekanRunes.push(null); // (0,7) - Vide
nezekanRunes.push(createRune(0, 8, "rare", 3)); // (0,8) - Rare - Passive ID 3
...
nezekanRunes.push(createRune(1, 2, "legend", 5)); // (1,2) - Legend - Ability ID 5
...
nezekanRunes.push(createRune(2, 0, "rare", 1)); // (2,0) - Rare - Passive ID 1
...
nezekanRunes.push(createRune(2, 5, "legend", 3)); // (2,5) - Legend - Ability ID 3
nezekanRunes.push(createRune(2, 6, "common", {maxHP: commonStats.maxHP })); // (2,6) - Common
nezekanRunes.push(null); // (2,7) - Vide
nezekanRunes.push(createRune(2, 8, "legend", 8)); // (2,8) - Legend - Ability ID 8
nezekanRunes.push(createRune(2, 9, "common", {maxHP: commonStats.maxHP })); // (2,9) - Common
nezekanRunes.push(createRune(2, 10, "rare", 4)); // (2,10) - Rare - Passive ID 4
...
nezekanRunes.push(createRune(4, 2, "legend", 2)); // (4,2) - Legend - Ability ID 2
...
nezekanRunes.push(createRune(4, 7, "rare", 5)); // (4,7) - Rare - Passive ID 5
...
nezekanRunes.push(createRune(5, 0, "legend", 2)); // (5,0) - Legend - Ability ID 12
...
nezekanRunes.push(createRune(5, 10, "legend", 6)); // (5,10) - Legend - Ability ID 6
...
nezekanRunes.push(createRune(6, 3, "rare", 4)); // (6,3) - Rare - Passive ID 4
...
nezekanRunes.push(createRune(6, 8, "legend", 1)); // (6,8) - Legend - Ability ID 1
...
nezekanRunes.push(createRune(8, 0, "rare", 5)); // (8,0) - Rare - Passive ID 5
nezekanRunes.push(createRune(8, 1, "common", {mp: commonStats.mp })); // (8,1) - Common
nezekanRunes.push(createRune(8, 2, "rare", 3)); // (8,2) - Rare - Passive ID 3
nezekanRunes.push(null); // (8,3) - Vide
nezekanRunes.push(createRune(8, 4, "common", {mp: commonStats.mp })); // (8,4) - Common
nezekanRunes.push(createRune(8, 5, "legend", 11)); // (8,5) - Legend - Ability ID 11
...
nezekanRunes.push(createRune(8, 10, "rare", 2)); // (8,10) - Rare - Passive ID 2
...
nezekanRunes.push(createRune(9, 2, "rare", 3)); // (9,2) - Rare - Passive ID 3
...
nezekanRunes.push(createRune(9, 8, "legend", 7)); // (9,8) - Legend - Ability ID 7
nezekanRunes.push(createRune(9, 9, "rare", 1)); // (9,9) - Rare - Passive ID 1
...
nezekanRunes.push(createRune(10, 2, "rare", 3)); // (10,2) - Rare - Passive ID 3 (à vérifier selon l'image)
nezekanRunes.push(null); // (10,3) - Vide
nezekanRunes.push(createRune(10, 4, "legend", 11)); // (10,4) - Legend - Ability ID 11 (à vérifier selon l'image)
nezekanRunes.push(createRune(10, 5, "common", {criticalHit: commonStats.criticalHit})); // (10,5) - Common
nezekanRunes.push(createRune(10, 6, "rare", 1)); // (10,6) - Rare - Passive ID 1 (à vérifier selon l'image)
